    ...
    return (
        <div className='grid gap-4'>
            {trainers.map((trainer, index) => (
              ...
              <figure><img src={trainer.photoUrl || "https://img.freepik.com/premium-vector/man-avatar-profile-picture-vector-illustration_268834-538.jpg"} alt="Trainer Profile"  className="w-32 h-32 md:rounded-full mb-4 object-cover"/></figure>
